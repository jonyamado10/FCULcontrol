...
<script type="text/javascript">
    $("#retrocederBtn").click(function(){
      $("#content").load("<?php echo base_url("Docente/aulasPorDisciplinaLicenciatura/").$id_disciplina ?>");
    });
    $('#tabela').DataTable({
  
        "ajax": {
            url : "<?php echo base_url("Tabelas/tabela_presencas_aula_licenciatura/").$id_aula ?>",
            type : 'GET'
        },
              "language": {
