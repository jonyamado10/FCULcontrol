<div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i><?php echo " ".$disciplina ?> | Alunos Inscritos Total
...
<script type="text/javascript">
    ...
    $('#tabela').DataTable({
        ...
        "ajax": {
            url : "<?php echo base_url("Tabelas/tabela_total_alunos_inscritos_disciplina_pos_graduacao/").$id_disciplina ?>",
            type : 'GET'
        },
              "language": {
