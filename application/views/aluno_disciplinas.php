<div class="container-fluid">
    ...
    <table class="table table-bordered" id="tabela-disciplinas" cellspacing="0">
     <thead>
   <tr>
    <th>Disciplina</th><th>Regente</th><th>Semestre</th><th>ECTS</th><th>Turma</th><th>Ano Letivo</th><th>Grau</th><th></th></tr>
     </thead>
     <tbody>
     </tbody>
      <tfoot>
...
<script type="text/javascript">
    ...
    $('#tabela-disciplinas').DataTable({
        ...
        "ajax": {
            url : "<?php echo base_url("Tabelas/tabela_disciplinas_user_aluno") ?>",
            type : 'GET'
        },
              "language": {
