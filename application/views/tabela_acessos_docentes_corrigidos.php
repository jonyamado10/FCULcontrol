<div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Docentes
            <div class = "corrigir">
            <div id = "corrigirText"><i class="fa fa-backward"></i> Reverter</div>
            <label class="switch">
              <input id = "s" type="checkbox" value = "corrigir" title="Corrigir Acessos" checked> 
...
$('#tabela tfoot th').each( function () {
   ...
   var url = "<?php echo base_url("Tabelas/acessos_docentes_corrigidos") ?>";
