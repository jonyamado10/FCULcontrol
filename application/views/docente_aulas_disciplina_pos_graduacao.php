<div class="container-fluid">
    ...
    <table class="table table-bordered" id="tabela" width="100%" cellspacing="0">
     <thead>
   <tr>
    <th>Disciplina</th><th>Turma</th><th>Data</th><th>Horário</th><th>Sala</th><th>Aula Nº</th><th></th></tr>
     </thead>
     <tbody>
     </tbody>
      <tfoot>
...
<script type="text/javascript">
  $("#retrocederBtn").click(function(){
    ...
    $('#tabela').DataTable({
        ...
        "ajax": {
            url : "<?php echo base_url("Tabelas/tabela_aulas_disciplina_pos_graduacao/").$id_disciplina ?>",
            type : 'GET'
        },
              "language": {
