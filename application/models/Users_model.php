...
//ALUNOS TABELA
 ...
 // DOCENTES TABELA
    ...
    function get_avg_percentagem_por_disciplina_user_docente(){
    	$disciplinas = $this->function get_percentagem_por_disciplina_user_docente();
    	$soma=0;
    	foreach ($disciplinas as $disciplina) {
    			$soma += round($disciplina["total_presencas"]/$disciplina["total_presencas"] * 100,3);
    	}
    	return round($soma/sizeof($disciplina),3);
    }
}
?>